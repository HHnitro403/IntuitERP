...
-- Fornecedor
INSERT INTO fornecedor (razao_social, nome_fantasia, cnpj, email, telefone, endereco, numero, bairro, cod_cidade, cep, ativo) VALUES
...
-- Produto
INSERT INTO produto (descricao, categoria, preco_unitario, saldo_est, est_minimo, tipo, fornecedor_id, ativo) VALUES
...
-- Cliente
INSERT INTO cliente (nome, email, telefone, cpf, data_nascimento, endereco, numero, bairro, cod_cidade, cep, ativo) VALUES
...
-- Vendedor
INSERT INTO vendedor (nome_vendedor, qtd_vendas, qtd_vendas_finalizadas, comissao, ativo) VALUES
('João Silva Santos',       145, 132, 5.0, TRUE),
('Maria Oliveira Costa',    198, 185, 5.0, TRUE),
('Pedro Henrique Souza',    123, 115, 5.0, TRUE);

-- Venda
INSERT INTO venda (data_venda, hora_venda, valor_total, forma_pagamento, status_venda, obs, cod_cliente, cod_vendedor) VALUES
('2025-11-10', '10:30:00', 4548.00, 'PIX',               2, 'Cliente corporativo', 1, 2),
('2025-11-11', '14:15:00', 1899.00, 'Cartão de Crédito', 2, NULL,                  4, 1);

-- Itens Venda
INSERT INTO itens_venda (cod_produto, cod_venda, quantidade, preco_unitario, descricao) VALUES
(5, 1, 10, 499.00,  'Mouse Logitech MX Master 3'),
(7, 1,  5, 699.00,  'Teclado Mecânico Keychron K2'),
(8, 2,  1, 1899.00, 'Monitor LG 27pol 4K');

-- Compra
INSERT INTO compra (data_compra, valor_total, status_compra, cod_fornecedor) VALUES
('2025-11-01', 82475.00, 2, 1);

-- Itens Compra
INSERT INTO itens_compra (cod_produto, cod_compra, quantidade, preco_unitario) VALUES
(1, 1, 25, 3299.00);

-- Estoque
INSERT INTO estoque (cod_produto, tipo, qtd, data) VALUES
(1, 'E', 25, '2025-11-01'),
(5, 'S', 10, '2025-11-10');
